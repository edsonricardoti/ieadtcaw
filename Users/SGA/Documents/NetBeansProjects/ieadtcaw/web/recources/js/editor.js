...
(function ($) {
    ...
    $.cleditor = {
        ...
        buttons: {
            ...
            "highlight,Cor do texto iluminado,hilitecolor,color|" +
            "removeformat,Remover formatos,|" +
            "bullets,Topicos,insertunorderedlist|" +
            "numbering,Niveis numericos,insertorderedlist|" +
            "outdent,Indentação pra fora,|" +
            "indent,Indentação pra dentro,|" +
            "alignleft,Alinhamento esquerdo,justifyleft|" +
            "center,Centralizado,justifycenter|" +
            "alignright,Alinhamento direito,justifyright|" +
            "justify,Justificado,justifyfull|" +
            "undo,Desfazer,|" +
            "redo,Refazer,|" +
            "rule,Inserir linha,inserthorizontalrule|" +
            "image,Inserir imagem,insertimage,url|" +
            "link,Inserir hiperlink,createlink,url|" +
            "unlink,Remover hiperlink,|" +
            "cut,Cortar,|" +
            "copy,Copiar,|" +
            "paste,Colar,|" +
            "pastetext,Colar como texto,inserthtml,|" +
            "print,Imprimir,|" +
